...
ActiveRecord::Schema.define(version: 20140820101527) do
  ...
  add_index "receipts", ["purchase_id"], name: "index_receipts_on_purchase_id"

  create_table "receives", force: true do |t|
    t.string   "receive_document"
    t.date     "receive_date"
    t.string   "receive_title"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
